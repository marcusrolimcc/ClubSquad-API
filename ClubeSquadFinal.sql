...
insert tb_produto_loja(descricao, valor, quantidade, id_loja) values ('Chapéu', 55, 20, 1)
...
insert tb_produto_loja(descricao, valor, quantidade, id_loja) values ('Óculos', 160, 10, 1)
...
insert tb_pedido_loja(descricao, id_produto_loja, id_quarto) values ('Cartão ed Crédito', 5, 2)

insert tb_restaurante(descricao) values ('Delícias do campo')
